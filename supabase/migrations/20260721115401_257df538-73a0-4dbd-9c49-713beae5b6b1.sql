CREATE INDEX IF NOT EXISTS idx_consumption_rows_org_meter
  ON public.consumption_rows (organization_id, meter_name);

CREATE INDEX IF NOT EXISTS idx_consumption_rows_org_building
  ON public.consumption_rows (organization_id, building_id);

CREATE INDEX IF NOT EXISTS idx_consumption_rows_org_interval
